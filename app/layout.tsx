...
export const metadata: Metadata = {
  title: 'Chris Davis - Portfolio',
  description:
    'Chris Davis is a full-stack devloper with 8 years of experience',
};
...
export default function RootLayout({
  ...
  return (
    <html lang='en' className='!scroll-smooth'>
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 h-[5000px]`}
      >
