...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
  ...
  return (
    <motion.section
      ...
      className='group bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden relative mb-3 sm:pr-8 sm:h-[20rem] sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition'
    >
